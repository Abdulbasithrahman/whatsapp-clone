...
function CapturePhoto({hide,setImage}) {
  ...
  return(
    <div className="absolute h-4/6 w-2/6 top-1/4 left-1/3 bg-gray-900 gap-3 rounded-lg pt-2 flex items-center justify-center">
      ...
      <div className="pr-2 cursor-pointer flex items-end justify-end" 
              onClick={() => hide(false)}>
              ...
              <button className="h-14 w-14 bg-white rounded-full cursor-pointer border-8 border-teal-light p-2"
